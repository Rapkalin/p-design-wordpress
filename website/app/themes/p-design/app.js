...
window.Cookies = __webpack_require__(/*! ./lib/cookies */ "./resources/js/lib/cookies.js");
window.$script = __webpack_require__(/*! scriptjs */ "./node_modules/scriptjs/dist/script.js");
$(function () {
  __webpack_require__(/*! ./lib/svg */ "./resources/js/lib/svg.js");
  __webpack_require__(/*! ./lib/slick */ "./resources/js/lib/slick.js");
  ...
  __webpack_require__(/*! ./modules/animations */ "./resources/js/modules/animations.js");
  __webpack_require__(/*! ./modules/tabs */ "./resources/js/modules/tabs.js");
  __webpack_require__(/*! ./modules/popup */ "./resources/js/modules/popup.js");
  __webpack_require__(/*! ./modules/realisations */ "./resources/js/modules/realisations.js");
...
(function (factory) {
  ...
  var pluses = /\+/g;
  function encode(s) {
    return _api.raw ? s : encodeURIComponent(s);
  }
  function decode(s) {
    return _api.raw ? s : decodeURIComponent(s);
  }
  function stringifyCookieValue(value) {
    return encode(_api.json ? JSON.stringify(value) : String(value));
  }
  function parseCookieValue(s) {
    ...
    try {
      ...
      return _api.json ? JSON.parse(s) : s;
    } catch (e) {}
  }
  function read(s, converter) {
    var value = _api.raw ? s : parseCookieValue(s);
  ...
  var _api = function api(key, value, options) {
    // Write

    if (arguments.length > 1 && !isFunction(value)) {
      options = extend(_api.defaults, options);
  ...
  _api.get = _api.set = _api;
  _api.defaults = {};
  _api.remove = function (key, options) {
    // Must not alter options, thus extending a fresh object...
    _api(key, '', extend(options, {
      expires: -1
    }));
    return !_api(key);
  };
...
$('.user_register_email_field').on('change', function () {
  $('.user_register_login_field').val($(this).val());
});
$('.lwa-register-form #password1').attr('placeholder', 'Mot de passe');
$('.lwa-register-form #password2').attr('placeholder', 'Confirmer votre mot de passe');
...
jQuery(document).ready(function ($) {
  ...
  $('form.lwa-form, form.lwa-remember, div.lwa-register form').submit(function (event) {
    ...
    $.ajax({
      ...
      success: function success(data) {
        if (data.result == true) {
          lwaAjax({
            message: '<strong>Connexion en cours...</strong> Vous allez être redirigé dans un instant.',
            result: true
          }, statusElement);
          setTimeout(function () {
  ...
  $('.lwa-modal').each(function (i, e) {
    ...
    $('body').append($('<div class="lwa popup popup-register popup-auth"></div>').append(modal));
  });
  $(document).on('click', ".lwa-links-modal", function (e) {
    var target = $(this).parents('.lwa').data('modal');
    if (target.parent().hasClass('popup-register')) {
...
if ($('#map').length > 0) {
  $script('https://maps.googleapis.com/maps/api/js?key=AIzaSyB_fg8zbb3B_fztRJh5hlV8sKQ5MhTVPNc', function () {
    var myLatLng = {
      lat: 48.817550,
      lng: 2.392830
    };
...
/***/ "./resources/js/modules/realisations.js":
/*!**********************************************!*\
  !*** ./resources/js/modules/realisations.js ***!
  \**********************************************/
/*! no static exports found */
...
$('.tab-link').on('click', function (e) {
  $this = $(this), $tab = $this.attr('data-tab');
  e.preventDefault();
...
__webpack_require__(/*! /Users/rapkalin/Sites/p-design-wordpress/website/app/themes/p-design/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/rapkalin/Sites/p-design-wordpress/website/app/themes/p-design/resources/sass/style.scss */"./resources/sass/style.scss");
